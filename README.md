...
- `push.yml`: 3 запуска в сутки по UTC (соответствуют `09:00 / 13:00 / 19:00` Europe/Moscow):
  - `0 6 * * *`
  - `0 10 * * *`
  - `0 16 * * *`

В коде `push scheduled` использует окна MSK с допуском на sync drift: morning `08:50–10:10`, midday `12:50–14:10`, evening `18:50–20:10`.
...
```bash
python main.py schedule-debug --at 2026-02-24T08:55:00+03:00
python main.py push morning
python main.py push midday
...
```bash
python main.py schedule-debug --at 2026-03-01T19:05:00+03:00
python main.py push evening
```
